...
- 🏠 Political portfolio and campaign information
- 📝 Volunteer registration form
- 🗳️ Voter center and surveys
...
```env
NEXT_PUBLIC_API_BASE_URL="https://admin.arsonconsultancy.org/api/v1"
```
